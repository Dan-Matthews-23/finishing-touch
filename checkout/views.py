...
"""
The problem is that the form (below) is never shown. This should be on basket.html, not checkout.html. This is because 
sandwiches.html opens process_order, then basket.html opens process_checkout.

I need to change the layout of the forms so that the crispy form stuff loads on process_order / basket.html
